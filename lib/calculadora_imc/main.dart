...
class _HomeState extends State<Home> {
  ...
  String _infoText = "Ïnforme os seus dados";
  ...
  void _resetFields() {
    ...
    _infoText = "Ïnforme os seus dados";
  }
  ...
  void _calculate() {
    setState(() {
      ...
      if (imc < 18.6) {
        ...
        _infoText = "Levemenge acima  (${imc.toStringAsPrecision(3)})";
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              Icon(Icons.person_outline, size: 110.0, color: Colors.green),
              TextField(
